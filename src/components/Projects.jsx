      ...
      <div className='project-container'>
        <div className='project-card'>
          ...
          <div className='project-details'>
            <p className='project-desc'>FurniTech is an application designed to facilitate the exploration and purchase of a wide array of furniture products. Users have the capability to establish an account, peruse an extensive inventory of furniture items, and conveniently add their selections to the shopping cart for either immediate or deferred acquisition. Inspiration from RH furniture's eccomerce website.</p>
        ...
        <div className='project-card'>
          ...
          <div className='project-details'>
            <p className='project-desc'>Using a design from a UX/UI designer to develop a frontpage mobile view of the bakery Davelle. It displays menu items with a clean look. When a user adds an item to their cart, the cart logo updates. It contains a light and dark mode.</p>
            <div className='project-btns'>
